      ...
      <transition name="slide-up">
        <div v-if="isOpen" class="border-t border-gray-200">
          <div class="p-4 space-y-3">
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <h3 class="font-bold">Template 2: Principal Madrid</h3>
                <Icon
              ...
              <p class="text-xs text-gray-600 mb-2">Black & white luxury, full-screen video hero</p>
              <div class="flex items-center space-x-2">
                <div class="w-4 h-4 rounded-full bg-black" title="Black"></div>
                <div class="w-4 h-4 rounded-full" style="background:#C9A96E" title="Gold"></div>
